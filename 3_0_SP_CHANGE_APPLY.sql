...
CREATE OR REPLACE PROCEDURE <deployment database name>.GTS_STG.SP_CHANGE_APPLY(STREAM_NM VARCHAR, TGT_SCHMA VARCHAR, TGT_TABLE VARCHAR, DB VARCHAR, SRC_SCHMA VARCHAR, SRC_TABLE VARCHAR)
